...
return [
    ...
    */
    'core' => [
        ...
        'mode'=>'aliyun',//上传方式,local 为本地   aliyun 为阿里云
        //阿里云配置,若mode='aliyun',以下为必填.
        'aliyun'=>[
            'ossServer' => 'http://oss-cn-hangzhou.aliyuncs.com',
            'ossServerInternal' => 'http://oss-cn-hangzhou.aliyuncs.com',//;'http://oss-cn-hangzhou-internal.aliyuncs.com',
            'AccessKeyId' => 'RHEoGgTj746G9HRU',
            'AccessKeySecret' => 'AIEJsoe9FdmVooXCmkSFcl1PFtmiZW',
